...
Overviewnizer reads text files on a folder and converts them to the Attract Mode overview format and vice-versa.
Overviewnizer can also convert frm the old to the new format.
...
- View File button:
When a file is selected on the file list it can be opened on the File View window. (more on that later)
